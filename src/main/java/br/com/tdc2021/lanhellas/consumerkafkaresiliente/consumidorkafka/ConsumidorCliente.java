...
@Component
public class ConsumidorCliente extends ConsumidorClienteBase {

    @Value("${app.topico-cliente-retry1}")
    private String topicoRetry1;

    @Value("${app.tempo-retry1-segundos}")
    private long tempoRetry1Segundos;


    protected ConsumidorCliente(KafkaTemplate<String, Cliente> kafkaTemplate, ClienteRepositorio clienteRepositorio) {
